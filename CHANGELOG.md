...
### Changed / 调整
- Added a one-table npm version guide covering capability, scenario, inputs, required UI, integration method, and install command / 新增一张 npm 版本对照表，覆盖功能、场景、输入、所需 UI、使用方式与安装命令
